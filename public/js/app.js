...
/* harmony import */ var _burger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./burger */ "./resources/js/burger.js");
...
/* harmony import */ var _tariffs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tariffs */ "./resources/js/tariffs.js");
/* harmony import */ var _tariffs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_tariffs__WEBPACK_IMPORTED_MODULE_1__);
...
var burgerBtn = document.querySelector('.header__burger-container');
...
var priceCurrency = document.querySelectorAll('.tariff__price-currency');
var priceValue = document.querySelectorAll('.tariff__price-value');
var pricePeriod = document.querySelectorAll('.tariff__price-period');
var tariff = document.querySelectorAll('.tariff');
var dollarRate = 90;
var euroRate = 95;
priceCurrency.forEach(function (currency) {
  currency.addEventListener('click', function () {
    if (currency.innerHTML === '$') {
      priceCurrency.forEach(function (x) {
        x.innerHTML = '₽';
      }, priceValue.forEach(function (x) {
...
pricePeriod.forEach(function (period) {
  period.addEventListener('click', function () {
    if (period.innerHTML === '/Months') {
      pricePeriod.forEach(function (x) {
        x.innerHTML = '/Day';
      }, priceValue.forEach(function (x) {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/index"], () => (__webpack_require__("./resources/styles/index.sass")))
